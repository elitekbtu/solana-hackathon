...
import { Upload, Image as ImageIcon, Wallet, CheckCircle, AlertCircle } from 'lucide-react'
    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-blue-50">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-700 max-w-3xl mx-auto">
            Create, mint, and trade gaming NFTs with ease
          </p>
        </div>
      </section>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              {previewUrl ? (
                ...
                <div
                  ...
                  className="border-2 border-dashed border-blue-200 rounded-lg p-8 text-center hover:border-blue-400 transition-colors cursor-pointer"
                >
                  <Upload className="h-12 w-12 text-blue-400 mx-auto mb-4" />
                  <p className="text-blue-700">Click to upload an image</p>
          ...
          {/* NFT Details Section */}
          <div className="bg-white p-8 rounded-lg border border-blue-200">
            <h2 className="text-2xl font-semibold mb-6 text-blue-900">NFT Details</h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 h-20 resize-none"
                  ...
                  {nftData.attributes.map((attr, index) => (
                    <div key={index} className="flex space-x-2">
                      <input
                        ...
                        className="w-full px-3 py-2 border border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 flex-1"
              ...
              <button
                ...
                className="w-full py-3 text-lg bg-blue-900 text-white font-semibold rounded-lg hover:bg-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {isMinting ? (
        ...
        {mintResult && (
          <div className="mt-8 bg-white p-8 rounded-lg border border-blue-200">
            <h2 className="text-2xl font-semibold mb-6 text-blue-900">Mint Result</h2>
